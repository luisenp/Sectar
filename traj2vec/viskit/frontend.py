...
from traj2vec.viskit import core
...
def reload_data():
    ...
    exps_data = core.load_exps_data(args.data_paths,args.disable_variant, args.csv_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--csv_name", default="progress.csv")
