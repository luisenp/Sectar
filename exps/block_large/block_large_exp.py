...
from traj2vec.envs.playpen.blockplaypengym_large import reward_fn, init_rstate
import os
import sys
import json
...
# name of gym env
variant_group.add_argument('--env_name', default='BlockPlaypen-Large-v0')
...
with open('/private/home/lep/sectar/variant_block.json', 'r') as f:
